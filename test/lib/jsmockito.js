 ...
 * @param {String} mockName an optional name for the mock returned when calling toString()
 * @return {object} a mock object
 */
JsMockito.mock = function(Obj, mockName) {
	var delegate = {};
    if (mockName) {
        delegate.toString = function () { return mockName };
    }
